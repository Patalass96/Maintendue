            ...
            <div class="nav-menu" id="main-menu">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="{{ route('donations.index') }}" class="dropdown-item">
                ...
                <a href="{{ route('associations.index') }}"
                    class="nav-link {{ request()->is('associations*') ? 'active' : '' }}">
                    ...
                    <div class="dropdown user-menu">
                        ...
                        <div class="dropdown-menu user-dropdown">
                            ...
                            @elseif(auth()->user()->role === 'association')
                                <a href="{{ route('associations.dashboard') }}" class="dropdown-item">
                                    <i class="fas fa-tachometer-alt"></i> Mon Dashboard
                                </a>
                                <a href="{{ route('associations.profile') }}" class="dropdown-item">
                                    <i class="fas fa-user"></i> Mon profil
                                </a>
                            @else
                                <a href="{{ route('donator.dashboard') }}" class="dropdown-item">
                                    <i class="fas fa-tachometer-alt"></i> Mon Dashboard
                                </a>
                                <a href="{{ route('donator.profile') }}" class="dropdown-item">
                                    <i class="fas fa-user"></i> Mon profil
                                </a>
                            @endif
                            <hr>
