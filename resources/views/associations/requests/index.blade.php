                        ...
                        <form method="GET" class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="type" name="type">
                                    ...
                                    <option value="clothing" {{ request('type') == 'clothing' ? 'selected' : '' }}>Vêtements
                                    </option>
                                    <option value="food" {{ request('type') == 'food' ? 'selected' : '' }}>Alimentaire
                                    </option>
                                    <option value="school" {{ request('type') == 'school' ? 'selected' : '' }}>Scolaire
                                    </option>
                                    <option value="furniture" {{ request('type') == 'furniture' ? 'selected' : '' }}>Meubles
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="date" name="date">
                                    ...
                                    <option value="today" {{ request('date') == 'today' ? 'selected' : '' }}>Aujourd'hui
                                    </option>
                                    <option value="week" {{ request('date') == 'week' ? 'selected' : '' }}>Cette semaine
                                    </option>
                                    <option value="month" {{ request('date') == 'month' ? 'selected' : '' }}>Ce mois
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        <span
                                            class="badge bg-{{ $request->status == 'pending' ? 'warning' : ($request->status == 'accepted' ? 'success' : 'danger') }}">
                                        ...
                                        @if ($request->donation)
                                            ...
                                            <div class="d-flex align-items-center">
                                                @if ($request->donation->primaryImage)
                                                    <img src="{{ $request->donation->primaryImage->url }}" alt="Don"
