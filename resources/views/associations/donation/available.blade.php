            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="btn-group" role="group">
                        <a href="{{ route('association.donations.available') }}?filter=all" 
                           class="btn btn-outline-primary {{ !request('filter') || request('filter') == 'all' ? 'active' : '' }}">
                            Tous les dons
                        </a>
                        <a href="{{ route('association.donations.available') }}?filter=near" 
                           class="btn btn-outline-primary {{ request('filter') == 'near' ? 'active' : '' }}">
                            Proches de moi
                        </a>
                        <a href="{{ route('association.donations.available') }}?filter=urgent" 
